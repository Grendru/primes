...
Primes::Primes(uint32_t max, char mode)
{
	...
	else throw "Incorrect generate mode";
}
/*!
...
/*!
\return Итератор после применения операции операции сложения.
*/
Primes::Iterator Primes::Iterator::operator+(uint32_t n)
 {
	return Iterator(cur + n); 
 }
/*!
\return Итератор после применения операции операции вычитания.
*/
Primes::Iterator Primes::Iterator::operator-(uint32_t n) 
{ 
	return Iterator(cur - n); 
...
/*!
\return Итератор после применения операции префиксной инкрементации.
*/
...
/*!
\return Итератор после применения операции префиксной декрементации.
*/
Primes::Iterator Primes::Iterator::operator--(int) 
{ 
	return Iterator(cur--); 
...
/*!
\return Итератор после применения операции постфиксной инкрементации.
*/
...
/*!
\return Итератор после применения операции постфиксной декрементации.
*/
Primes::Iterator Primes::Iterator::operator--() 
{ 
	return Iterator(--cur);
